...
@WebServlet("/UpdateBalanceServlet2")
public class UpdateBalanceServlet2 extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (status == 1){
            request.setAttribute("UpdateBalanceStatus","用户信息更改成功");
            request.getRequestDispatcher("UpdateBalanceStatus.jsp").forward(request,response);
        }
