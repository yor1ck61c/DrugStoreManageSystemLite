...
<div class="content-front"><h1 class="display-4" style="margin-top: 100px; margin-left: 600px; color: gainsboro">当前药品库存</h1></div>
            ...
            <table class="table table-bordered" style="margin-top: 220px;margin-left: 100px; text-align:center;color: gainsboro">
                ...
                <c:forEach items="${requestScope.medicineInfos.items}" var="medicine">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/UpdateMedicineInfoServlet?id=${medicine.id}" style="color: gainsboro; ">修改</a>
                            <a href="${pageContext.request.contextPath}/DeleteMedicineServlet?id=${medicine.id}" style="color: gainsboro; ">删除</a>
                        </td>
                    </tr>
                    </tbody>
                </c:forEach>
